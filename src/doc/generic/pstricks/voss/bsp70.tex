...
%\psgrid[gridwidth=.1mm,subgridwidth=.1mm,gridlabels=0pt,subgriddiv=1,gridcolor=gray]%
%(0,0)(-3,-5)(9,6)
...
\htick{0.5}
\pscircle[linewidth=.3mm,linecolor=blue](4,0){2.332}
\pscircle[linewidth=.3mm,linecolor=red](0,0){1.166}
%
\end{pspicture}
\hspace{1em}
...
\pscircle[linewidth=.3mm,linecolor=red](0,0){2.332}
\pscircle[linewidth=.3mm,linecolor=blue](2,0){1.166}
\end{pspicture}
