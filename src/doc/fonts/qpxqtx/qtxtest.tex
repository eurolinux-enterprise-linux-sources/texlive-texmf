...
Litery $g, v, w, y$ posiadaj± odmianê, której mo¿emy u¿yæ pisz±c
\verb+\varg+ itd.: $\varg, \varv, \varw, \vary$.
U¿ycie pakietu z~opcj± \verb+[altg]+ spowoduje, ¿e domy¶lnie zostan±
u¿yte $\varg\varv\varw\vary$ a~dodaj±c \verb+\var+ otrzymamy $gvwy$.

$$A,\dots,Z\quad a,\dots,z\quad \Gamma, \dots,\Omega\quad
 \varGamma, \dots, \varOmega\quad
 \alpha,\dots,\omega$$%\quad \varg \varv \varw \vary,\quad gvwy$$ 
\smallskip
