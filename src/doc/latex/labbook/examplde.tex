...
\newexperiment{prep_S-peptide}{Pr^^e4paration von RNase-A-S-Peptid}
...
A wurde nach der Vorschrift in M^^fcller \textit{et al.} hergestellt und
vorl^^e4ufig im Eisschrank gelagert.
